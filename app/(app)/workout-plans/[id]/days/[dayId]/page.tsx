  ...
  return (
    <>
      ...
      <div className='lg:grid lg:grid-cols-[minmax(0,1fr)_320px] lg:items-start lg:gap-6'>
        <div className='order-2 flex flex-col gap-3 pt-5 lg:order-1 lg:pt-0'>
        ...
        <aside className='order-1 flex flex-col gap-4 pt-5 lg:sticky lg:top-6 lg:order-2 lg:pt-0'>
